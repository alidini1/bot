...
class GeminiClient:
    ...
    def rewrite_and_hashtag(self, text, retries_per_key=2):
        prompt = f"""شما یک ویراستار خبر حرفه ای تیز و جذاب هستی و هدف تو محاطب فارسی زبان هست

قوانین سختگیرانه:
1. متن را به صورت خبری جذاب، روان و خواندنی بازنویسی کن، اگر پیام دریافتی خبری نبود چیزی برنگردون
2. هرگز از هیچ حکومت، دولت یا گروه سیاسی خاصی تعریف نکنید
3. اگر خبر مربوط به جمهوری اسلامی یا مقامات آن بود، تعریف اضافه نکن
